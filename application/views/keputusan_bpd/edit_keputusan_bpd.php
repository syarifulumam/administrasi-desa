<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control " name="nomor_keputusan"
				value="<?= $keputusan_bpd->nomor_keputusan ?>" autocomplete="off">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal" value="<?= $keputusan_bpd->tanggal ?>" class="form-control"
