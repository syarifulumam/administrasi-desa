	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<select class="form-control select2" style="width: 100%;" name="nama" id="nama">
				...
				<option value="<?= $key->id_penduduk ?>"
					<?= $key->id_penduduk == $kematian->id_penduduk ? 'selected':'' ?>><?= $key->nama_lengkap ?>
				</option>
				<?php endforeach; ?>
			</select>
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal_kematian" value="<?= $kematian->tanggal_meninggal ?>"
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal_pemakaman" value="<?= $kematian->tanggal_pemakaman ?>"
					class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd"
					data-mask>
			</div>
