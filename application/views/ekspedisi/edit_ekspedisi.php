	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal_pengiriman" value="<?= $ekspedisi->tanggal_pengiriman ?>"
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal_surat" value="<?= $ekspedisi->tanggal_surat ?>" class="form-control"
