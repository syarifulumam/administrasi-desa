<div class="card">
	...
	<div class="card-body">
		...
		<div class="form-group">
			...
			<input type="number" min="0" class="form-control " name="dana_pemerintah" value="<?= $rencana_pembangunan->sumber_dana_pemerintah ?>" autocomplete="off">
			<?= form_error('dana_pemerintah','<small class="text-danger pl-1">','</small>') ?>
		</div>
		<div class="form-group">
			<label>Sumber Dana Provinsi</label>
			<input type="number" min="0" class="form-control " name="dana_provinsi" value="<?= $rencana_pembangunan->sumber_dana_provinsi ?>" autocomplete="off">
			<?= form_error('dana_provinsi','<small class="text-danger pl-1">','</small>') ?>
		</div>
		<div class="form-group">
			<label>Sumber Dana Kota</label>
			<input type="number" min="0" class="form-control " name="dana_kota" value="<?= $rencana_pembangunan->sumber_dana_kota ?>" autocomplete="off">
			<?= form_error('dana_kota','<small class="text-danger pl-1">','</small>') ?>
		</div>
		<div class="form-group">
			<label>Sumber Dana Swadaya</label>
			<input type="number" min="0" class="form-control " name="dana_swadaya" value="<?=  $rencana_pembangunan->sumber_dana_swadaya ?>" autocomplete="off">
