<div class="card">
	...
	<div class="card-body">
		<?= form_open_multipart('','',array('id'=>$identitas->id_identitas));?>
		<div class="row">
			<div class="col-sm-4">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<input type="text" class="form-control " name="no_faxe" value="<?= $identitas->no_fax ?>"
						autocomplete="off">
					<?= form_error('no_faxe','<small class="text-danger pl-1">','</small>') ?>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="form-group">
					...
					<input type="text" class="form-control " name="no_faxe" value="<?= $identitas->format_waktu ?>"
						autocomplete="off">
					<?= form_error('no_faxe','<small class="text-danger pl-1">','</small>') ?>
				</div>
			</div>
