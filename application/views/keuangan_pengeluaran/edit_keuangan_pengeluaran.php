<div class="card">
	...
	<div class="card-body">
		<?= form_open('','',array('id'=>$keuangan->id_keuangan,'status'=>'pengeluaran'));?>
		...
		<div class="form-group">
			<label>Jumlah</label>
			<input type="number" min="0" class="form-control " name="harga" value="<?= $keuangan->harga ?>">
		...
		<div class="form-group">
			...
			<div class="input-group">
				...
				<input type="text" name="tanggal" class="form-control" data-inputmask-alias="datetime"
					data-inputmask-inputformat="dd/mm/yyyy"  value="<?= date('d-m-Y', strtotime($keuangan->tanggal)) ?>" data-mask>
			</div>
